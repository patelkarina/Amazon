...
final class Controller {
    ...
    /** Sets the winner.
     * @param piece what we set to winner */
    void setWinner(Piece piece) {
        _winner = piece;
    }
    ...
    private Command[] _commands = {
        ...
        new Command(String.format("%s", Move.MOVE_PATTERN), this::doMove)
    };
     ...
     * @param unused matcher*/
    private void doDump(Matcher unused) {
        System.out.printf("===%n%s===%n", _board);
    }

    /** Command "auto C" where C is the automated player.
     * @param mat the matched content */
    private void doAuto(Matcher mat) {
        Piece p = Piece.valueOf(mat.group(1).toUpperCase());
        if (p == WHITE) {
    ...
    /** Command "manual C" where C is the manual player.
     * @param mat the matched content */
